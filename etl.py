...
container_name = "manifest"  # One container with folders inside
...
try:
    ...
    for blob in blob_list:
        if blob.name.endswith(".csv"):
            ...
            # Save to outbound/ with the same filename
    ...
    send_status("Success", "ETL pipeline completed successfully.")

except Exception as e:
    send_status("Failure", f"ETL pipeline failed: {str(e)}")
    raise
